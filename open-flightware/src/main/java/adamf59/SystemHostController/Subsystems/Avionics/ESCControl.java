...
public class ESCControl implements ElectronicSpeedController {
    ...
    private void initializeESC() {
        ...
        Gpio.pinMode(this.bcmPinNumber, com.pi4j.wiringpi.Gpio.PWM_OUTPUT);
